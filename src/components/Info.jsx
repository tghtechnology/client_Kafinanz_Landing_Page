const Info = () => {
  return (
    <section className="lg:h-[704px] relative bg-[url('image/info.png')] bg-no-repeat bg-cover bg-right py-8 md:py-3 px-4">
      ...
      <article className="z-10 relative 3xl:max-w-7xl 3xl:mx-auto">
          <h4 className="font-bold my-8 md:py-14 text-white text-[16px] md:text-[28px] max-w-[225px] md:max-w-max before:content-[''] after:block after:bg-white after:h-1 after:rounded-md">RECOPILACIÓN Y ENTREGA DE INFORMACIÓN</h4>
          <ul className="space-y-4 text-white text-sm md:text-2xl list-disc ml-4 md:ml-8 mb-24 md:mb-0 max-w-[208px] md:max-w-xl md:space-y-8">
            <li>
