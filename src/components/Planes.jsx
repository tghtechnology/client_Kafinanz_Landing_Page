  ...
  return (
    <>
      <div className="container mx-auto mt-14 p-2">
        ...
        <div className="relative grid gap-2 text-white md:grid-cols-planes-desktop place-content-center md:gap-10 px-5 py-5 ">
          ...
          <div className="bg-[url('/image/plan-mensual.webp')] bg-no-repeat bg-cover rounded-[70px] h-[334px] max-h-[334px] min-h-[220px] lg:h-[667px] lg:max-h-[600px] flex flex-col justify-end py-8 px-4 lg:px-5 gap-3 lg:py-20">
            ...
            <ul className="list-disc text-[18px] ml-6 lg:text-xl">
          ...
          <div className="bg-[url('/image/plan-cotizacion.webp')] bg-no-repeat bg-cover rounded-[70px] h-[434px] max-h-[434px] md:min-h-[500px] lg:h-[667px] lg:max-h-[600px] flex flex-col justify-end lg:pb-[108px]  py-8 px-4 lg:px-5 gap-3 lg:py-20">
          ...
          <div className="bg-[url('/image/plan-auditoria.webp')] bg-no-repeat bg-cover rounded-[70px] h-[534px] max-h-[494px] lg:h-[667px] lg:max-h-[600px] flex flex-col justify-end py-8 px-4 lg:px-5 gap-3 lg:py-20">
            <h2 className="text-lg lg:text-3xl uppercase after:content-[' '] after:block after:w-full after:h-1 after:bg-white after:rounded-md">
