    ...
    <>
      <div className="container mx-auto mt-14 p-2">
        ...
        <div className="relative grid gap-4 text-white md:grid-cols-planes-desktop place-content-center md:gap-14 px-5">
          ...
          <div className="bg-[url('/image/plan-cotizacion.jpg')] bg-no-repeat bg-cover rounded-[70px] h-[434px] max-h-[434px] lg:h-[667px] lg:max-h-[600px] flex flex-col justify-end lg:pb-[108px]  py-8 px-4 lg:px-5 gap-3 lg:py-20">
          ...
          <div className="bg-[url('/image/plan-auditoria.jpg')] bg-no-repeat bg-cover rounded-[70px] h-[534px] max-h-[494px] lg:h-[667px] lg:max-h-[600px] flex flex-col justify-end py-8 px-4 lg:px-5 gap-3 lg:py-20">
