  ...
  return (
    <div className="mb-6">
      ...
      <section className="grid sm:grid-cols-2 md:grid-cols-4 text-2xl text-center font-semibold text-white h-full max-h-[800px] md:h-[500px] 3xl:max-w-7xl 3xl:mx-auto px-2 gap-x-4 gap-y-4">
        ...
        <article className="bg-clip-bg bg-gradient-to-b from-[#4C1165] to-[#CC0E34] text-transparent grid place-content-center py-4 max-w-[331px] rounded-[110px]">
          <p className="md:max-w-[280px] text-white">
            Acceso a documentos originales en todo momento.
          </p>
        </article>
        <article className="bg-clip-bg bg-gradient-to-b from-[#4C1165] via-[#8E077D] to-[#FFA401] text-transparent grid place-content-center py-4  max-w-[331px] rounded-[110px]">
          <p className="md:max-w-[280px] text-white">
            Ahorro en costos al no contratar personal contable fijo.
          </p>
        </article>
        <article className="bg-clip-bg bg-gradient-to-b from-[#0847AD]  to-[#4C1165] text-transparent grid place-content-center py-4 max-w-[331px] rounded-[110px]">
          <p className="md:max-w-[280px] text-white">
